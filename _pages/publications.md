...
<div class="notice--info" style="margin-bottom: 4em; font-size: 2em; text-align: center;">
  <strong style="font-size: 1.8em" >Total Papers: {{ site.data.pub_stats.total }} </strong>&nbsp;|&nbsp;
  <strong style="font-size: 1.8em" >First-Author Papers: {{ site.data.pub_stats.first_author }} </strong>&nbsp;|&nbsp;
  <strong>Selected Contributing Papers:{{ site.data.pub_stats.selected }}</strong> 
  <br>
